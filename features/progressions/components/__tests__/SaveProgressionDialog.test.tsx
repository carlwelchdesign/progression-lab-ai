...
describe('SaveProgressionDialog', () => {
  ...
  it('should render dialog when open is true', () => {
    renderWithProviders(
      <SaveProgressionDialog open={true} onClose={jest.fn()} chords={mockChords} />,
    );
  ...
  it('should not render dialog when open is false', () => {
    renderWithProviders(
      <SaveProgressionDialog open={false} onClose={jest.fn()} chords={mockChords} />,
    );
  ...
  it('should call onClose when Cancel button clicked', async () => {
    ...
    renderWithProviders(
      <SaveProgressionDialog open={true} onClose={mockOnClose} chords={mockChords} />,
    );
